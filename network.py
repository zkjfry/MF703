...
def network(
    ...
    dataset_train_x = data_n[features].values[:dataset_train_length]
    dataset_train_y = data_n['Close'].values[:dataset_train_length]

    dataset_test_x = data_n[features].values[dataset_train_length:]
    dataset_test_y = data_n['Close'].values[dataset_train_length:]
